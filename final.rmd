...
qplot(data = wine, x = alcohol, y = ..density.., geom = "histogram", fill=I("blue"), col=I("red"),  alpha=I(.2), xlab = "alcohol (% by volume)", ylab = "count", binwidth = 1/8) + stat_density(geom = "line")
...
ggplot(droped_outlier, aes(x=residual.sugar, y=alcohol)) +
  geom_jitter(alpha = .05)
ggplot(droped_outlier, aes(x=residual.sugar, y=density)) +
  geom_jitter(alpha = .05)
ggplot(droped_outlier, aes(x=alcohol, y=density)) +
  geom_jitter(alpha = .05)
```
